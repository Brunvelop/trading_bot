...
download_currency_data('BTC', 'EUR', days_to_download=7, interval='1m')
download_currency_data('BTC', 'EUR', days_to_download=60, interval='15m')
download_currency_data('BTC', 'EUR', days_to_download=720, interval='1h')
download_currency_data('BTC', 'EUR', days_to_download=720, interval='1d')
